...
Dim_Medications: MedicationID (PK), MedicationName, Manufacturer, Description


Dim_Insurance: InsuranceID (PK), PatientID, CompanyName, PolicyNumber, CoverageDetails, EffectiveDate, ExpiryDate


Dim_PatientAllergies: AllergyID (PK), PatientID, AllergyName, Severity
